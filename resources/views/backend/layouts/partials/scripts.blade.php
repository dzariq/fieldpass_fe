...
<script src="{{ fp_asset_path('backend/assets/js/vendor/jquery-2.2.4.min.js') }}"></script>
<!-- bootstrap 4 js -->
<script src="{{ fp_asset_path('backend/assets/js/popper.min.js') }}"></script>
<script src="{{ fp_asset_path('backend/assets/js/bootstrap.min.js') }}"></script>
<script src="{{ fp_asset_path('backend/assets/js/owl.carousel.min.js') }}"></script>
<script src="{{ fp_asset_path('backend/assets/js/metisMenu.min.js') }}"></script>
<script src="{{ fp_asset_path('backend/assets/js/jquery.slimscroll.min.js') }}"></script>
<script src="{{ fp_asset_path('backend/assets/js/jquery.slicknav.min.js') }}"></script>
...
<script src="{{ fp_asset_path('backend/assets/js/line-chart.js') }}"></script>
<!-- all pie chart -->
<script src="{{ fp_asset_path('backend/assets/js/pie-chart.js') }}"></script>
<!-- others plugins -->
<script src="{{ fp_asset_path('backend/assets/js/plugins.js') }}"></script>
<script src="{{ fp_asset_path('backend/assets/js/scripts.js') }}"></script>
