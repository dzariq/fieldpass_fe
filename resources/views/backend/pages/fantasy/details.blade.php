                            ...
                            <div class="data-tables">
                                ...
                                <table id="dataTable2" style="width:100%" class="text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $loop->index+1 }}</td>
                                            <td>{{ $match->home_club->name }} ({{$match->home_club_score }})</td>
                                            <td>({{$match->away_club_score }}) {{ $match->away_club->name }}</td>
                                            <td>{{ date('Y-m-d',$match->date) }}</td>
                                            <td>{{$match->status }}</td>
                                            <td><a href="{{ route('admin.match.match_info', ['id' => $match->id]) }}">View</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
