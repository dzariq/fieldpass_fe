                    ...
                    <div class="data-tables">
                        ...
                        <table id="dataTable" class="text-center">
                            <thead class="bg-light text-capitalize">
                                <tr>
                                    <th width="5%">{{ __('Sl') }}</th>
                                    <th width="10%">{{ __('Competition Name') }}</th>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->can('competition.manage_invites'))
                                            <a class="btn btn-success text-white" href="{{ route('admin.competition.invites.approve', $competition->id) }}">Approve</a>
                                            <a class="btn btn-danger text-white" href="{{ route('admin.competition.invites.reject', $competition->id) }}">Reject</a>
                                        @endif
